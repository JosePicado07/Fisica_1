...
\IfFileExists{logo_cenfotec.png}{%
  \includegraphics[width=0.45\textwidth]{logo_cenfotec.png}
}{%
...
\bottomrule
\end{tabularx}
\caption{Casos de prueba verificados sobre la clase \texttt{NewtonState}.}
\end{table}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figuras/figura1_modo_newton_1d.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figuras/figura2_modo_newton_2d.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figuras/figura0_modo_rebote.png}
...
\vspace{1cm}
\noindent\textit{Nota de formato para la entrega final: verificar texto justificado, fuente formal y uniforme, numeración de figuras y tablas, y que las referencias e imágenes cumplan con el formato APA 7.\textsuperscript{a} edición antes de entregar el PDF compilado.}
